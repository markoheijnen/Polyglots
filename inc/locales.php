...
class Polyglots_Locale {
	...
	public static function __set_state( $state ) {
		return new Polyglots_Locale( $state );
	}
...
class Polyglots_Locales {

	public $locales = array();

	public function __construct() {
		$aa = new Polyglots_Locale();
	...
	public static function &instance() {
		if ( ! isset( $GLOBALS['polyglots_locales'] ) ) {
			$GLOBALS['polyglots_locales'] = new Polyglots_Locales;
		}

		return $GLOBALS['polyglots_locales'];
	}
